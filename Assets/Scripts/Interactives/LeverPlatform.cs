...
public class LeverPlatform : AparicibleObject
{
    ...
    {
        base.UpdateOpacityBasedOnDistance(_ehyalTransform, Vector3.up, -10);
    ...
    private void Update()
    {
        ...
        {
            UpdateOpacityBasedOnDistance(_ehyalTransform, Vector3.up, -10);
            UpdateOpacity();
        }
    }
}
